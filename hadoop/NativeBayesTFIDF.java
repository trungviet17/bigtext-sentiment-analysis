...
public class NativeBayesTFIDF
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        wordcount_job.setJarByClass(NativeBayesTFIDF.class);
        ...
        tf_job.setJarByClass(NativeBayesTFIDF.class);
        ...
        tfidf_job.setJarByClass(NativeBayesTFIDF.class);
        ...
        feature_selection_job.setJarByClass(NativeBayesTFIDF.class);
        ...
        training_job.setJarByClass(NativeBayesTFIDF.class);
        ...
        testing_job.setJarByClass(NativeBayesTFIDF.class);
